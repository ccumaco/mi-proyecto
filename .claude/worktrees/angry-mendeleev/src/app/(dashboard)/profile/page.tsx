...
export default function Profile() {
  ...
  return (
    <div className="mx-auto w-full max-w-7xl space-y-8">
      {/* Profile Header */}
      <Card padding="lg" className="border-l-4 border-l-primary shadow-md">
        <div className="flex flex-col items-center gap-6 md:flex-row">
          <div
            className="size-24 rounded-full border-4 border-zinc-100 dark:border-zinc-800 bg-cover bg-center shadow-lg"
            style={{
          ...
          <div className="flex-1 text-center md:text-left space-y-2">
            ...
            <div className="flex flex-wrap justify-center gap-3 md:justify-start">
              ...
              <Badge variant="info">
                <FontAwesomeIcon icon={faCalendarDay} className="mr-1.5 h-3 w-3" />
                Desde Ene 2023
              </Badge>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        {/* Announcement Card */}
        <Card isHoverable className="flex flex-col h-full">
          ...
          <div className="mt-auto space-y-4">
            <div className="bg-zinc-50 rounded-lg p-3 dark:bg-zinc-800/50">
            ...
            <Link href="/announcements">
              <Button variant="ghost" className="w-full text-primary font-bold" size="sm">
        ...
        {/* Payment Card */}
        <Card isHoverable className="flex flex-col h-full border-t-4 border-t-green-500">
          <div className="mb-4 flex items-center justify-between">
          ...
          <div className="bg-zinc-50 mb-4 flex flex-1 flex-col items-center justify-center rounded-xl py-6 dark:bg-zinc-800/50">
        ...
        <Card isHoverable className="flex flex-col h-full">
          ...
          <div className="mt-auto space-y-3">
            <div className="flex items-center gap-3 rounded-xl border border-zinc-100 p-3 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-800/30 transition-colors">
            ...
            <Button variant="ghost" className="w-full text-primary font-bold mt-2" size="sm">
      ...
      <Card padding="none" className="overflow-hidden">
        ...
        <div className="divide-y divide-zinc-100 dark:divide-zinc-800">
          <DocumentItem name="Reglamento_Interno_2023.pdf" info="2.4 MB • Subido hace 5 días" />
          <DocumentItem name="Estado_Gastos_Comunes_Agosto.pdf" info="1.1 MB • Subido hace 12 días" />
        </div>
      </Card>
    </div>
  );
...
function DocumentItem({ name, info }: { name: string, info: string }) {
  return (
    <div className="hover:bg-zinc-50 flex items-center gap-4 px-6 py-4 transition-colors dark:hover:bg-zinc-800/30">
      <div className="bg-red-50 text-red-500 p-2.5 rounded-xl dark:bg-red-950/20">
